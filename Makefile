# This Makefile is for the Maypole::Plugin::Authentication::Abstract extension to perl.
#
...
#     NAME => q[Maypole::Plugin::Authentication::Abstract]
#     PREREQ_PM => { URI=>q[0], Maypole=>q[2.0] }
...
FULLEXT = Maypole/Plugin/Authentication/Abstract
BASEEXT = Abstract
PARENT_NAME = Maypole::Plugin::Authentication
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = Abstract.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Maypole/Plugin/Authentication
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Maypole/Plugin/Authentication
...
TO_INST_PM = Abstract.pm

PM_TO_BLIB = Abstract.pm \
	$(INST_LIB)/Maypole/Plugin/Authentication/Abstract.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  Abstract.pm $(INST_MAN3DIR)/Maypole::Plugin::Authentication::Abstract.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(MAKEFILE_OLD) $(FIRST_MAKEFILE) $(INST_LIB)/Maypole/Plugin/Authentication/Abstract.pm
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Abstract.pm $(INST_LIB)/Maypole/Plugin/Authentication/Abstract.pm 
	$(NOECHO) $(TOUCH) $@
